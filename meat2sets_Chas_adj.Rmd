---
title: " GE=Meat to Chastity Adjusted (Irina, OPSB-based) DEGs SEGs from NPSB; (ii) make standart format for both OPSB and NPSB, R Matlab (no set column)"
output:
